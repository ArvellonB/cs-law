                ...
                <div class="main-content">
                    <div class="container-fluid">
                        <div class="page-title">
                            <h4>Add a new Prospective Client</h4>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="hidden" name="employee" id="employee" value="<?php echo($_SESSION['username1']); ?>">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="text" class="form-control" name="clientname" id="form-1-1" placeholder="Potential Client Name">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
													...
													<div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="email" class="form-control" id="form-1-3" name="client1email" placeholder="Email">
                                                        </div>
                                                    </div>
													<div class="form-group row">
                                                        <label for="form-2-7" class="col-md-2 control-label">Address</label>
                                                        <div class="col-md-10">
                                                            <input type="text" class="form-control" id="form-2-7" name="clientaddress" placeholder="Address">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
		...
		else if(nima == "No")
			{
				...
				document.getElementById("marriedapp4").innerHTML="";
                        ...
                        <div class="row">
                                                ...
                                                <textarea name="personaltouch" id="personaltouch"></textarea>
                        </div>
                        <br>
