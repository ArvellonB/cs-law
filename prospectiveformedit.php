...
$servername="localhost";
																...
																session_start();
																$sql = "SELECT * FROM clients WHERE clientname = '".$_SESSION['clientname1']."'";
																...
																if($result->num_rows > 0)
																{
																	...
																	{ 
																		...
																		$_SESSION['countype1'] = $row['countype'];
																		$_SESSION['otherinfo1'] = $row['otherinfo'];
																		$_SESSION['apptquestion1'] = $row['apptquestion'];
																		$_SESSION['appointdate1'] = $row['appointdate'];
																		$_SESSION['appointime1'] = $row['appointime'];
																		$_SESSION['consloc1'] = $row['consloc'];
																		$_SESSION['levelofdif1'] = $row['levelofdif'];
																		$_SESSION['genwellet1'] = $row['genwellet'];
																		$_SESSION['genwelemail1'] = $row['genwelemail'];
																		$_SESSION['apptreason1'] = $row['apptreason'];
																		$_SESSION['gender1one'] = $row['gender1'];
																		$_SESSION['client1email1'] = $row['client1email'];
																		$_SESSION['clientaddress1'] = $row['clientaddress'];
																		$_SESSION['areyoumarried1'] = $row['areyoumarried'];
																		$_SESSION['spousename1'] = $row['spousename'];
																		$_SESSION['gender2one'] = $row['gender2'];
																		$_SESSION['phonespouse1'] = $row['phonespouse'];
																		$_SESSION['spouseemail1'] = $row['spouseemail'];
																		$_SESSION['tone1one'] = $row['tone1'];
																		$_SESSION['tone2one'] = $row['tone2'];
																		$_SESSION['tone3one'] = $row['tone3'];
																		$_SESSION['personaltouch1'] = $row['personaltouch'];
																		$_SESSION['lengthphonecall1'] = $row['lengthphonecall'];
																	}
																}
?>
<!DOCTYPE html>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-block">
                                        <div class="row">
                                            <div class="col-md-6">
                                            	<form class="form-horizontal mrg-top-40 pdd-right-30" method="post" action="prospectiveformsub.php">
												<input type="hidden" name="date" id="date" value="<?php echo date('Y-m-d'); ?>">
												<input type="hidden" name="time" id="time" value="<?php echo date('h:i:sa'); ?>">
                                                <input type="hidden" name="persontype" id="persontype" value="Prospective">
                                                ...
                                                <input type="hidden" name="employee" id="employee" value="<?php echo($_SESSION['username1']); ?>">
                                                    <div class="form-group row">
                                                        <label for="form-1-1" class="col-md-2 control-label">Potential Client Name</label>
                                                        <div class="col-md-10">
                                                            <input type="text" class="form-control" name="clientname" id="form-1-1" placeholder="Potential Client Name" value="<?php echo($_SESSION['clientname1']); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="form-1-2" class="col-md-2 control-label">Phone Number</label>
                                                        <div class="col-md-10">
                                                            <input type="tel" class="form-control" id="form-1-2" placeholder="Phone #" name="phone" value="<?php echo($_SESSION['phone1']); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="form-2-8" class="col-md-2 control-label">Type of Consultation Requested</label>
                                                        <div class="col-md-10">
                                                            <select id="countype" name="countype" onchange="getcounttype()">
																<option value = "Advanced estate planning">Advanced estate planning</option>
																<option value="Basic estate planning">Basic estate planning</option>
																<option value="Medi-Cal planning">Medi-Cal planning</option>
																<option value="Conservatorship">Conservatorship</option>
																<option value="Probate">Probate</option>
																<option value="Probate litigation">Probate litigation</option>
																<option value="Small estates and transfer on death">Small estates and transfer on death</option>
													...
													{
														var q1 = document.getElementById("countype").value;
														if(q1 == "Estate Planning")
														{
															document.getElementById("displaycount").innerHTML = "";
														}
														else if(q1 == "Bankruptcy")
														{
															document.getElementById("displaycount").innerHTML = "";
														}
														else if(q1 == "Other")
														{
															document.getElementById("displaycount").innerHTML = "<div class='form-group row'><label for='form-2-7' class='col-md-2 control-label'>Give me more info</label><div class='col-md-10'><input type='text' class='form-control' id='form-2-9' name='otherinfo' placeholder='More Description'></div> </div>";
														}
														else if(q1 == "")
														{
															document.getElementById("displaycount").innerHTML = "";
															alert("Please select the type of consultation");
														}
													}
												</script>
                                                <div id="marriedapp1"></div>
                                                <div id="marriedapp3"></div>
                                                    <div class="form-group row">
                                                        <label for="form-1-1" class="col-md-2 control-label">Does the prospect want to set up an appointment?</label>
                                                        <div class="col-md-10">
                                                            <select name="apptquestion" id="apptquestion" onChange="getapptans()">
													...
													function getapptans()
													{
														var r1 = document.getElementById("apptquestion").value;
														if (r1 == "")
														{
															document.getElementById("displayappt").innerHTML = "";
															document.getElementById("displayappt2").innerHTML = "";
															document.getElementById("displayappt3").innerHTML = "";
															document.getElementById("displayappt4").innerHTML = "";
															document.getElementById("displayappt5").innerHTML = "";
															document.getElementById("displayappt6").innerHTML = "";
															alert("Please answer the question in order to proceed!");
														}
														else if(r1 == "Yes")
														{
															document.getElementById("displayappt").innerHTML = "<div class='form-group row'><label for='form-2-11' class='col-md-2 control-label'>Consultation Date</label><div class='mrg-top-40'><div class='timepicker-input input-group'><span class='input-group-text'><i class='ti-calendar'></i></span><input type='text' class='form-control datepicker-2' placeholder='Pick your date' data-provide='datepicker' name='appointdate'></div></div></div>";
															document.getElementById("displayappt2").innerHTML = "<div class='form-group row'><label for='form-2-12' class='col-md-2 control-label'>Consultation Time</label><div class='col-md-10'><input type='time' class='form-control' id='form-2-12' placeholder='Enter Time' name='appointime'></div></div>";
															document.getElementById("displayappt3").innerHTML = "<div class='form-group row'><label for='form-2-12' class='col-md-2 control-label'>Consultation Location</label><div class='col-md-10'><select name='consloc' id='consloc'><option value='Claremont'>Claremont</option><option value='House Visit'>House Visit</option><option value='Corona'>Corona</option><option value='Riverside'>Riverside</option><option value='Rancho Cucamonga'>Rancho Cucamonga</option><option value='Beverly Hills'>Beverly Hills</option></select></div></div>";
															document.getElementById("displayappt4").innerHTML = "<div class='form-group row'><label for='form-2-12' class='col-md-2 control-label'>Level of Difficulty Setting Appointment</label><div class='col-md-10'><select id='levelofdif' name='levelofdif'><option value='' selected='selected'></option><option value='Easy'>Easy</option><option value='Medium'>Medium</option><option value='Hard'>Hard</option></select></div></div>";
															document.getElementById("displayappt5").innerHTML = "<div class='form-group row'><label for='form-2-12' class='col-md-2 control-label'>Generate Welcome Letter</label><div class='toggle-checkbox checkbox-inline toggle-sm mrg-top-10'><input type='checkbox' name='genwellet' id='toggle1' value='Generate Welcome Letter' checked><label for='toggle1'></label></div></div></div>"
															document.getElementById("displayappt6").innerHTML = "<div class='form-group row'><label for='form-2-13' class='col-md-2 control-label'>Generate Welcome Email</label><div class='toggle-checkbox checkbox-inline toggle-sm mrg-top-10'><input type='checkbox' name='genwelemail' id='toggle2' value='Generate Welcome Email' checked><label for='toggle2'></label></div></div></div>";
														}
														else if(r1 == "No")
														{
															document.getElementById("displayappt").innerHTML = "<div class='form-group row'><label for='form-1-5' class='col-md-2 control-label'>Reason</label><div class='col-md-10'><textarea class='form-control' rows='3' id='form-1-5' name='apptreason'></textarea></div></div>";
															document.getElementById("displayappt2").innerHTML = "";
															document.getElementById("displayappt3").innerHTML = "";
															document.getElementById("displayappt4").innerHTML = "";
															document.getElementById("displayappt5").innerHTML = "";
													...
													<div id="displayappt"></div>
													<div id="displayappt3"></div>
													<div id="displayappt5"></div>
                                            </div>
                                            <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="form-1-1" class="col-md-2 control-label">Gender</label>
                                                        <div class="col-md-10">
                                                            <select id="selectize-dropdown" name="gender1">
													...
													<div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="email" class="form-control" id="form-1-3" name="client1email" placeholder="Email" value="<?php echo($_SESSION['client1email1']); ?>">
                                                        </div>
                                                    </div>
													<div class="form-group row">
                                                        <label for="form-2-7" class="col-md-2 control-label">Address</label>
                                                        <div class="col-md-10">
                                                            <input type="text" class="form-control" id="form-2-7" name="clientaddress" placeholder="Address" value="<?php echo($_SESSION['clientaddress1']); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="form-1-1" class="col-md-2 control-label">Married</label>
                                                        <div class="col-md-10">
                                                            <select name="areyoumarried" id="areyoumarried" onChange="getCouple()">
...
function getCouple()
	{
		var nima = document.getElementById("areyoumarried").value;
		if(nima == "Yes")
			{
				document.getElementById("marriedapp1").innerHTML="<div class='form-group row'><label for='form-2-2' class='col-md-2 control-label'>Client 2 Name</label><div class='col-md-10'><input type='text' class='form-control' name='spousename' id='form-2-2' placeholder='Client 2 Name'></div></div>";
				document.getElementById("marriedapp2").innerHTML="<div class='form-group row'><label for='form-2-3' class='col-md-2 control-label'>Client 2 Gender</label><div class='col-md-10'><select id='selectize-dropdown' name='gender2'><option value='' disabled selected>Client 2 Gender</option><option value='Male'>Male</option><option value='Female'>Female</option></select></div></div>";
				document.getElementById("marriedapp3").innerHTML="<div class='form-group row'><label for='form-2-4' class='col-md-2 control-label'>Client 2 Phone Number</label><div class='col-md-10'><input type='phone' class='form-control' name='phonespouse' id='form-2-4' placeholder='Client 2 Phone'></div></div>";
				document.getElementById("marriedapp4").innerHTML="<div class='form-group row'><label for='form-2-5' class='col-md-2 control-label'>Client 2 Email</label><div class='col-md-10'><input type='email' class='form-control' name='spouseemail' id='form-2-5' placeholder='Client 2 Email'></div></div>";
			}
		else if(nima == "No")
			{
				document.getElementById("marriedapp1").innerHTML="";
				document.getElementById("marriedapp2").innerHTML="";
				document.getElementById("marriedapp3").innerHTML="";
				document.getElementById("marriedapp4").innerHTML="";
			}
		
	}
</script>
                                                    </div>
                                                    <div id="marriedapp2"></div>
                                                    <div id="marriedapp4"></div>
													<div id="displaycount"></div>
												<div id="displayappt2"></div>
												<div id="displayappt4"></div>
												<div id="displayappt6"></div>
                                                <div class="form-group row">
                                                        <label for="form-1-1" class="col-md-2 control-label">Tone of Conversation</label>
                                                        <div class="col-md-10">
                                                            <select id="selectize-dropdown" name="tone1">
                                                                <option value="" disabled selected></option>
                                                                <option value="Agitated">Agitated</option>
                                                                <option value="Complementary">Complementary</option>
                                                                <option value="Confused">Confused</option>
                                                                <option value="Easy-Going">Easy-Going</option>
                                                                <option value="Hard-to-Understand">Hard-to-Understand</option>
                                                                <option value="Overtalkative">Overtalkative</option>
                                                                <option value="Rude">Rude</option>
                                                            </select>
                                                            <select id="selectize-dropdown" name="tone2">
                                                                <option value="" disabled selected></option>
                                                                <option value="Agitated">Agitated</option>
                                                                <option value="Complementary">Complementary</option>
                                                                <option value="Confused">Confused</option>
                                                            ...
                                                            <select id="selectize-dropdown" name="tone3">
                                                                <option value="" disabled selected></option>
                                                                <option value="Agitated">Agitated</option>
                                                                <option value="Complementary">Complementary</option>
                                                                <option value="Confused">Confused</option>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-block">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h4 class="card-title">Notes Regarding Legal Matter </h4>
                        ...
                        <div class="row">
                                                <h4 class="card-title">Personal Touch </h4>
                                                <textarea name="personaltouch" id="personaltouch"><?php echo($_SESSION['personaltouch1']); ?></textarea>
                        </div>
                        <br>
                        <h4 class="card-title">Length of Phone Call: <input type="text" name="lengthphonecall" id="lengthphonecall" value=""></h4>
