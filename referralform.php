                ...
                <div class="main-content">
                    <div class="container-fluid">
                        <div class="page-title">
                            <h4>Add a new Referral Partner</h4>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-block">
                                        <div class="row">
                                            <div class="col-md-6">
                                            	<form class="form-horizontal mrg-top-40 pdd-right-30" method="post" action="referralformsub.php">
												<input type="hidden" name="date" id="date" value="<?php echo date('Y-m-d'); ?>">
												<input type="hidden" name="time" id="time" value="<?php echo date('h:i:sa'); ?>">
                                                <input type="hidden" name="persontype" id="persontype" value="Referral Partner">
                                                ...
                                                <input type="hidden" name="employee" id="employee" value="<?php echo($_SESSION['username1']); ?>">
                                                    <div class="form-group row">
                                                        <label for="form-1-1" class="col-md-2 control-label">Company Name</label>
                                                        <div class="col-md-10">
                                                            <input type="text" class="form-control" name="companyname" id="form-1-1" placeholder="Company Name">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="form-1-2" class="col-md-2 control-label">Work Number</label>
                                                        <div class="col-md-10">
                                                            <input type="Phone" class="form-control" id="form-1-2" placeholder="Work Phone #" name="workphone">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="form-1-2" class="col-md-2 control-label">Fax Number</label>
                                                        <div class="col-md-10">
                                                            <input type="Phone" class="form-control" id="form-1-2" placeholder="Fax Phone #" name="faxphone">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="form-2-8" class="col-md-2 control-label">Business Type</label>
                                                        <div class="col-md-10">
                                                            <select id="businesstype" name="businesstype" onchange="getbusinesstype()">
													...
													{
														var q1 = document.getElementById("businesstype").value;
														if(q1 == "Legal")
														{
															document.getElementById("tyob").innerHTML = "";
														}
														else if(q1 == "Financial")
														{
															document.getElementById("tyob").innerHTML = "";
														}
														else if(q1 == "Real Estate")
														{
															document.getElementById("tyob").innerHTML = "";
														}
														else if(q1 == "Bank")
														...
														{
															document.getElementById("tyob").innerHTML = "<div class='form-group row'><label for='form-1-1' class='col-md-2 control-label'>Other Business Type</label><div class='col-md-10'><input type='text' class='form-control' name='otherbusinesstype' id='form-1-1' placeholder='Other Business Type'></div></div>";
														}
													}
												</script>
                                                    <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
													<div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="email" class="form-control" id="form-1-3" name="referralemail" placeholder="Email">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="form-1-2" class="col-md-2 control-label">Cell Number</label>
                                                        <div class="col-md-10">
                                                            <input type="Phone" class="form-control" id="form-1-2" placeholder="Cell Phone #" name="cellphone">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="form-1-1" class="col-md-2 control-label">Mail Address</label>
                                                        <div class="col-md-10">
                                                            <input type="text" class="form-control" name="mailaddress" id="form-1-1" placeholder="Mail Address">
                                                        </div>
                                                    </div>
                                                    <div id="tyob"></div>
													<div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <select name="discloseclientinfo" id="discloseclientinfo" onchange="discloseclinfo()">
                                                    ...
                                                    <script>
													function discloseclinfo()
													{
														var q1 = document.getElementById("discloseclientinfo").value;
														if(q1 == "No")
														{
															document.getElementById("disclosecli").innerHTML = "";
														}
														else if(q1 == "Yes")
														{
															document.getElementById("disclosecli").innerHTML = "<div class='form-group row'><label for='form-1-1' class='col-md-2 control-label'>Referred by</label><div class='col-md-10'><select id='selectize-dropdown' name='whichclient'><?php $servername='localhost'; $username='root'; $password='Jr91766jr'; $dbname='lawmanagement'; $conn = new mysqli($servername, $username, $password, $dbname); if ($conn->connect_error) { die('Connection failed: ' . $conn->connect_error); } session_start(); $sql = 'SELECT * FROM clientacct '; $result = $conn->query($sql); if($result->num_rows > 0) { while($row = mysqli_fetch_array($result)) { ?> <option value=\"<?php echo($row['clientname']); ?>\"><?php echo($row['clientname']); ?></option> <?php  } } ?></select></div> </div>";
														}
													}
												</script>
                                                    <div id="disclosecli"></div>
                                                <div class="form-group row">
